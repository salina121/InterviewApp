...
namespace InterviewBot.Services
{
    ...
    public class OpenAIAgentService : IAIAgentService
    {
        ...
        public OpenAIAgentService(IConfiguration config, ILogger<OpenAIAgentService> logger)
        {
            ...
            {
                ApiKey = "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",
